...
function main() {
    ...
    # 获取课程列表
    curl_std_curriculum_list=$(curl "https://jxky.web2.superchutou.com/service/eduSuper/Specialty/GetStuSpecialtyCurriculumList?StuDetail_ID=${StuDetail_ID}&IsStudyYear=1&StuID=${StuID}" -H "$header_accept" -H "$header_accept_language" -H "$header_access_control_allow_origin" -H "$header_cache_control" -H "$header_connection" -H "$header_content_type" -H "$header_cookie" -H "$header_user_agent" --compressed --insecure -s)
    ...
    # 获取 期末考试的信息
    final_exam_info=$(curl "https://jxky.web2.superchutou.com/service/eduSuper/Question/GetFinalExamPaperView?StuDetail_ID=${StuDetail_ID}&Curriculum_ID=${curriculum_id}&Examination_ID=0" -H "$header_accept" -H "$header_accept_language" -H "$header_access_control_allow_origin" -H "$header_cache_control" -H "$header_connection" -H "$header_content_type" -H "$header_cookie" -H "$header_user_agent" --compressed --insecure -s)
    ...
    # 自动提交/交卷
    # while true; do
    #     curl_SubmitExamPractice=$(curl 'https://jxky.web2.superchutou.com/service/eduSuper/Question/SubmitExamPractice' --data-raw "$real_answare_compain" -H "$header_accept" -H "$header_accept_language" -H "$header_access_control_allow_origin" -H "$header_cache_control" -H "$header_connection" -H "$header_content_type" -H "${header_cookie}; themeName=default" -H "$header_user_agent" --compressed --insecure -s)
