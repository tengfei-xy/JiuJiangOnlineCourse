...
function main() {
    ...
    # 获取期末考试 的信息
    final_exam_info=$(curl "https://jjxy.web2.superchutou.com/service/eduSuper/Question/GetFinalExamPaperView?StuDetail_ID=${StuDetail_ID}&Curriculum_ID=${curriculum_id}&Examination_ID=0" -H "$header_accept" -H "$header_accept_language" -H "$header_access_control_allow_origin" -H "$header_cache_control" -H "$header_connection" -H "$header_content_type" -H "$header_cookie" -H "$header_user_agent" --compressed --insecure -s)
    ...
    # 获取阶段测评的所有问题与答案
    curl_exam_result=$(curl "https://jjxy.web2.superchutou.com/service/eduSuper/Question/GetExamPaperResult?busId=${exam_paper_id}&resultId=${exam_result_id}" -H "$header_accept" -H "$header_accept_language" -H "$header_access_control_allow_origin" -H "$header_cache_control" -H "$header_connection" -H "$header_content_type" -H "$header_cookie" -H "$header_user_agent" --compressed --insecure -s)
    ...
    # https://jjxy.web2.superchutou.com/service/eduSuper/Question/SubmitSimplePractice
